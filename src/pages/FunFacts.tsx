  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12 space-y-12">
      ...
      <div className="group space-y-5">
        <div className="prose prose-lg prose-gray prose-headings:font-serif prose-headings:font-medium prose-a:text-primary-600 hover:prose-a:text-primary-700 prose-a:no-underline hover:prose-a:underline">
